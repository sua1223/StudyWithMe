...
try {
	...
	try{
		...
		String query = "update user_info set timetable_url = '" + fullpath + "' where id = '" + session.getAttribute("sessionID") + "'";
		...
		if(rs.next())
		{
			session_fullpath = rs.getString("timetable_url");
		}
...
<body> 
<img src="<%= session_fullpath %>" width= "270px" height= "420px"></img> 

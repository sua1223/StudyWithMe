...
<body>
   <div class="frame" style="width:0px; margin:auto;">
     <iframe src="headerAndNavi.jsp" width="1700px" height="900px" scrolling = "no" frameborder ="0" style="position:relative; left:50%; margin-left:-850px; border-style:none;"></iframe>
      ...
      <div class = "column middle" style="position:absolute; padding-bottom:25px; top:-70px; border:1px solid #D9D9D9; border-radius:7px; background-color:#ffffff; clear:both;">
   ...
   <iframe src="footer.jsp" width="1200px" height="200px" scrolling = "no" frameborder="0" style="position:relative; clear:both; bottom:-1750px;"></iframe>
   </div>
   </div>
</body> 
</html>  